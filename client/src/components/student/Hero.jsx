...
const Hero = () => {
  ...
  return (
    ...
    px-7 md:px-0 space-y-7 text-center bg-gradient-to-b from-cyan-100/70'>
      ...
      text-gray-800 max-w-3x1 mx-auto'>Empower your future with the courses
      designed to <span  className='text-blue-600'>fit your choice.</span>
      <img src={assets.sketch} alt="sketch" 
      className='md:block hidden absolute -bootom-7 right-0' /></h1>

      <p className='md:block hidden text-gray-500 max-w-2x1 mx-auto'>
        We bring together world-class instructors, interactive
        content, and a supportive commmunity to help you achieve your personal and 
        professional goals.
      </p>
