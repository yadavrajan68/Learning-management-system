    ...
    <footer className='bg-gray-900 md:px-36 text-left w-full mt-10'>
      ...
      md:px-0 justify-center gap-10 md:gap-32 py-10 border-b border-white/30'>
          ...
          <div className='hidden md:flex flex-col items-start w-full'>
            <h2 className='font-semibold text-white mb-5'>
              ...
              <p className='text-sm text-white/80'>The latest news, articles, and resources,
                ...
                <div className='flex items-center gap-2 pt-4'>
                  <input className='border text-white border-gray-500/30 bg-gray-800 text-ray-500
            ...
            <p className='py-4 text-center text-xs md:text-sm text-white/60'>Copyright 2025 © Learning Management System. All Right Reserved </p>
    </footer>
