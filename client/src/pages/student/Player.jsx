...
// }
  ...
  const getCourseData = () => {
    // Use `find` to locate the course by ID
                    ...
                    <div key={index} className='border border-gray-300 bg-white mb-2 rounded'>
                      ...
                      cursor-pointer select-none' onClick={()=> toggleSection(index)}>
                        <div className='flex items-center gap-2'>
                          <img className={`transition transition-transform ${openSections[index] ? 'transform rotate-180' : 'transform rotate-0'}`} 
                          src={assets.down_arrow_icon || null} alt='down_arrow_icon'/>
