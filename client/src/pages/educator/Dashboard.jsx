  ...
  return dashboardData ? (
    ...
    md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <div className='space-y-5'>
        <div className='flex flex-wrap gap-5 items-center'>
          ...
          p-4 w-56 rounded-md'>
            ...
            <div>
              ...
              <p className='text-base text-gray-500'>Total Enrolled Students</p>
            </div>
        ...
        <div>
          <h2 className='pb-4 text-lg font-medium'>Latest Enrollmens</h2>
                ...
                {dashboardData.enrolledStudentsData.map((item, index) => (
                  <tr key={index} className='border-b border-gray-500/20'>
                    <td className='md:px-4 py-3 text-center hidden sm:table-cell'>
                      {index + 1}</td>
                    <td className='md:px-4 px-2 py-3 items-center flex space-x-3'>
